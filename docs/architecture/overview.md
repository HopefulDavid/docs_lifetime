...
Změny receptu a JSON se nasazují v jednom statickém artefaktu; nesoulad počtu vykreslených a datových kroků se přizná chybou a ponechá původní čitelný recept.
