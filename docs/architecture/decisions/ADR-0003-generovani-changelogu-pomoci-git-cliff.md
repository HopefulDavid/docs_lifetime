...
- Výstup musí být deterministický, český, kategorizovaný, odkazovat na přesný commit a viditelně označit breaking change.
...
Oba dokumentační projekty používají stejnou šablonu, parsery, pořadí skupin, časové pásmo `Europe/Prague`, integrační test a npm příkaz; liší se pouze nutnou identitou GitHub repozitáře v bloku `remote.github`.
